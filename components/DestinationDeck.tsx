...
export default function DestinationDeck() {
  ...
  return (
    <section className="relative bg-[#080808] py-24 px-4 overflow-hidden">
      {/* Background hint */}
              ...
              <div className="bg-[#111111] border border-white/5 p-8 md:p-12 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      onClick={() => go(-1)}
                      className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/50 hover:border-white/40 hover:text-white transition-all duration-200"
                      aria-label="Previous"
                    >
                      ←
                    </button>

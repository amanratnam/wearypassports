...
export default function ResultPageContent() {
  ...
  const handleDownloadPDF = () => {
    // Add print class to body so print CSS applies cleanly
    ...
    <>
      ...
      <div id="print-header" className="hidden">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <div className="brand-name">Weary Passports</div>
            <div className="brand-tag">AI-powered travel planning for Indian explorers</div>
          </div>
          <div className="brand-contact" style={{ textAlign: "right" }}>
            aman@wearypassports.com<br />
            wearypassports.com
          </div>
        </div>
      </div>
      ...
      <div id="print-footer" className="hidden">
        Generated by Weary Passports · aman@wearypassports.com · wearypassports.com ·
        Plan generated {new Date().toLocaleDateString("en-IN", { day: "numeric", month: "long", year: "numeric" })} ·
        For personal use only. Not for redistribution.
      </div>

      <Navbar />
      <main className="min-h-screen bg-[#080808] pt-16 print-result">
        {/* Page header */}
        <div className="border-b border-white/8 bg-[#0a0a0a]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <Link href="/planner" className="no-print inline-flex items-center gap-1.5 text-sm text-white/35 hover:text-white transition-colors mb-3">
              ...
              <div className="no-print flex items-center gap-3">
                ...
                <button onClick={handleDownloadPDF} className="btn-gradient flex items-center gap-2 text-sm">
